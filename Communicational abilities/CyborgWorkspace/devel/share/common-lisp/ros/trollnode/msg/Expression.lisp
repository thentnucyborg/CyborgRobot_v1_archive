...
(cl:defmethod cl:initialize-instance :after ((m <Expression>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Expression)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name trollnode-msg:<Expression> is deprecated: use trollnode-msg:Expression instead.")))

(cl:ensure-generic-function 'speech-val :lambda-list '(m))
(cl:defmethod speech-val ((m <Expression>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader trollnode-msg:speech-val is deprecated.  Use trollnode-msg:speech instead.")
  (speech m))

(cl:ensure-generic-function 'expression-val :lambda-list '(m))
(cl:defmethod expression-val ((m <Expression>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader trollnode-msg:expression-val is deprecated.  Use trollnode-msg:expression instead.")
  (expression m))
